...
#  samp = sample(pop, n_sampled, replace=FALSE)
#  sum(samp)
#}
#
...
sim_unif = rhyper(n_sims, n_marked, unif_prior - n_marked, n_sampled)
sim_pois = rhyper(n_sims, n_marked, pois_prior - n_marked, n_sampled)
